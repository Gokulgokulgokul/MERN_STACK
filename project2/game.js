//print the values of X and O inside the xo table
let val =1;
function click1(obj){
    if(obj.innerHTML=="")
        {
...
//ensure the key value and check one by one
function exe(obj){
    ...
    //call to reset the table
function reset(){
// {
//     var val=1;
//     if(val==1) {
//                   document.getElementById('btn').innerHTML="RESETED"
//                   val=0;
//                }
//     else {
